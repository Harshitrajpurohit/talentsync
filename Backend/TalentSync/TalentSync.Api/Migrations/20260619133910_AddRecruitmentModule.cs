        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Result = table.Column<string>(type: "nvarchar(450)", nullable: false, defaultValue: "Pending"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Screenings_Applications_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "Applications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ApplicationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Decision = table.Column<string>(type: "nvarchar(450)", nullable: false, defaultValue: "Pending"),
                    Notes = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Selections_Applications_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "Applications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Screenings_Result",
                table: "Screenings",
                column: "Result");

            migrationBuilder.CreateIndex(
                name: "IX_Screenings_ScreeningDate",
                table: "Screenings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Selections_CreatedAt",
                table: "Selections",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_Selections_Decision",
                table: "Selections",
                column: "Decision");

            migrationBuilder.CreateIndex(
                name: "IX_Selections_SelectionDate",
                table: "Selections",
                column: "SelectionDate");
        }
