...
namespace TalentSync.Application.Interfaces.Repositories
{
    public interface IUserRepository
    {
        ...
        Task<int> CountNonDeletedUsersAyns(CancellationToken cancellationToken);
        Task<int> CountByStatusAsync(UserStatus status ,CancellationToken cancellationToken);
        ...
        Task<List<User>> GetCandidatesAsync(PaginationRequest paginationRequest, Guid roleId, CancellationToken cancellationToken);
        Task<int> CountCandidatesAsync(CancellationToken cancellationToken);
    }
}
