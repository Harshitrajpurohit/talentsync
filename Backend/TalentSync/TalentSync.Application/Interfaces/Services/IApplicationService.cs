...
namespace TalentSync.Application.Interfaces.Services
{
    public interface IApplicationService
    {
        ...
        Task<ApplicationProfileResponseDto> GetByIdAsync(Guid id, CancellationToken cancellationToken);
        Task<PaginationResponse<ApplicationWithDetailsResponseDto>> GetAllAsync(ApplicationPaginationRequest paginationRequest, CancellationToken cancellationToken);
        Task<PaginationResponse<ApplicationWithDetailsResponseDto>> GetByJobIdAsync(Guid jobId, PaginationRequest paginationRequest, CancellationToken cancellationToken);
