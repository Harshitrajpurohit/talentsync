...
namespace TalentSync.Application.Services.Recruitment
{
    public class ScreeningService : IScreeningService
    {
        ...
        public ScreeningService(IScreeningRepository screeningRepository, IMapper mapper, IApplicationRepository applicationRepository, IUnitOfWork unitOfWork)
        {
        ...
        public async Task<ScreeningResponseDto> CreateScreeningAsync(CreateScreeningRequestDto screeningRequestDto, Guid screenedById, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                Screening newScreening = await _screeningRepository.AddAsync(screening, cancellationToken);
