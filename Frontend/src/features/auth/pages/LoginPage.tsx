import { BriefcaseBusiness, Search, CalendarCheck, ShieldCheck } from "lucide-react";
        ...
        <div className="relative hidden flex-col justify-between border-b border-slate-800 p-6 sm:flex sm:p-8 lg:w-5/12 lg:border-b-0 lg:border-r">
          <div>
            ...
            <div className="mt-8">
              ...
              <p className="mt-2 text-sm leading-relaxed text-slate-400">
                Log in to view active job listings, submit resumes, and manage your ongoing applications.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-3.5 pt-6">
            <div className="flex items-center gap-3">
              ...
              <p className="text-sm font-medium text-slate-300">Discover top tech & business roles</p>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-emerald-500/10 text-emerald-400">
                <CalendarCheck className="h-3.5 w-3.5" />
              </div>
              <p className="text-sm font-medium text-slate-300">Manage interview schedules</p>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-emerald-500/10 text-emerald-400">
                <ShieldCheck className="h-3.5 w-3.5" />
              </div>
              <p className="text-sm font-medium text-slate-300">Seamless application management</p>
            </div>
          </div>
