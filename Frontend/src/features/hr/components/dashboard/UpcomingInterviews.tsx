          ...
          <table className="w-full">
            <thead className="bg-[#F8FAF9] dark:bg-[#1e3329]">
              <tr>
                ...
                <th className="p-4 text-left text-xs font-bold uppercase tracking-wider text-[#75837D] dark:text-white/70">Date & Time</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-[#E5EAE7] dark:divide-[#315343]">
              {interviews.map((interview) => (
                <tr key={interview.id} className="group transition-colors hover:bg-[#F8FAF9]/50 dark:hover:bg-[#1e3329]/50">
                  ...
                  <td className="p-4 text-sm font-medium text-[#75837D] dark:text-white/80">{interview.jobTitle}</td>
