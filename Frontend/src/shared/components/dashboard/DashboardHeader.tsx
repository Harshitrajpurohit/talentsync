...
export default function DashboardHeader({
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-[20px] bg-[#315343] shadow-sm">
      <div className="absolute -right-8 -top-8 h-32 w-32 rounded-full bg-[#C3F53C]/15 blur-2xl" />
      <div className="absolute -bottom-10 -left-10 h-32 w-32 rounded-full bg-white/5 blur-2xl" />

      <div className="relative z-10 flex flex-col justify-between gap-4 px-5 py-5 sm:flex-row sm:items-center sm:px-6">
        ...
        <div className="hidden shrink-0 items-center justify-center sm:flex">
          <div className="relative flex h-14 w-14 items-center justify-center rounded-full border-2 border-[#C3F53C]/30 bg-white/5 backdrop-blur-md transition-transform duration-500 hover:scale-105 md:h-16 md:w-16">
            ...
            <Icon
              className="h-7 w-7 text-[#C3F53C] md:h-8 md:w-8"
              strokeWidth={1.2}
            />
        ...
        <div className="absolute right-4 top-4 sm:hidden">
          <Icon
            className="h-8 w-8 text-[#C3F53C]/30"
            strokeWidth={1}
          />
        </div>
      </div>
